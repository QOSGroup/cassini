...
func main() {
	...
	for _, vLog := range logs {
		...
		// fmt.Println("data: ", string(vLog.Data))
	...
	fmt.Println("hash: ", hash.Hex()) // 0xe79e73da417710ae99aa2088575580a60415d359acfad9cdd3382d59c80281d4
}
