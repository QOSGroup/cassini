...
// copy from tendermint/rpc/core/blocks.go
...
// BlockchainInfo Get block headers for minHeight <= height <= maxHeight.
...
func BlockchainInfo(minHeight, maxHeight int64) (*ctypes.ResultBlockchainInfo, error) {
	...
	return &ctypes.ResultBlockchainInfo{LastHeight: 0, BlockMetas: nil}, nil
}
...
func Block(heightPtr *int64) (*ctypes.ResultBlock, error) {
	...
	return &ctypes.ResultBlock{BlockMeta: nil, Block: nil}, nil
}
...
func Commit(heightPtr *int64) (*ctypes.ResultCommit, error) {
	...
	return ctypes.NewResultCommit(nil, nil, true), nil
}
