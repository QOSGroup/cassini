...
// copy from tendermint/rpc/core/net.go
...
// UnsafeDialSeeds unsafe dial seeds
...
// UnsafeDialPeers unsafe dial peers
func UnsafeDialPeers(peers []string, persistent bool) (*ctypes.ResultDialPeers, error) {
	// if len(peers) == 0 {
	// 	return &ctypes.ResultDialPeers{}, errors.New("No peers provided")
	// }
	// // starts go routines to dial each peer after random delays
	// log.Info("DialPeers", "addrBook", addrBook, "peers", peers, "persistent", persistent)
