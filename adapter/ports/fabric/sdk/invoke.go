...
func (a *chaincodeInvokeAction) invoke(channelID, chaincodeID string, argsArray []Args) error {
	...
	executor := executor.NewConcurrent("Invoke Chaincode", Config().Concurrency)
	executor.Start()
